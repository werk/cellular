...
bool walkable_f(inout uint seed, uint transform, value tile_, out bool result) {
    ...
    switch(m_3) { case 0:
        value v_5 = v_2;
        if(v_5.Tile == NOT_FOUND) break;
        value v_6 = Background_d(v_5.Tile);
...
bool generateCave_r(inout uint seed, uint transform, inout value a1) {
    ...
    v_16 = ALL_NOT_FOUND;
    v_16.material = None;
    a1t.Tile = Foreground_e(v_16);
    value v_17;
    v_17 = ALL_NOT_FOUND;
    v_17.material = None;
    a1t.Tile = Background_e(v_17);
    } else {
    a1t = ALL_NOT_FOUND;
    a1t.material = Rock;
    uint v_18;
...
bool generateChest_r(inout uint seed, uint transform, inout value a1) {
    ...
    v_11.Tile = Content_e(v_12);
    uint v_13;
    v_13 = 0u;
    if(v_13 >= 101u) return false;
    v_11.Tile = v_13;
    a1t.Tile = BuildingVariant_e(v_11);
...
bool generateImps_r(inout uint seed, uint transform, inout value a1) {
    ...
    v_35 = ALL_NOT_FOUND;
    v_35.material = Left;
    a1t.Tile = DirectionH_e(v_35);
    value v_36;
    v_36 = ALL_NOT_FOUND;
    v_36.material = None;
    a1t.Tile = ImpClimb_e(v_36);
    uint v_37;
    v_37 = 0u;
...
bool generateCave2_r(inout uint seed, uint transform, inout value a1) {
    ...
    v_17 = ALL_NOT_FOUND;
    v_17.material = None;
    a1t.Tile = Foreground_e(v_17);
    value v_18;
    v_18 = ALL_NOT_FOUND;
    v_18.material = None;
    a1t.Tile = Background_e(v_18);
...
bool generateImp2_r(inout uint seed, uint transform, inout value a1) {
    ...
    v_26 = ALL_NOT_FOUND;
    v_26.material = Left;
    v_25.Tile = DirectionH_e(v_26);
    value v_27;
    v_27 = ALL_NOT_FOUND;
    v_27.material = None;
    v_25.Tile = ImpClimb_e(v_27);
    uint v_28;
    v_28 = 0u;
    ...
    v_29 = ALL_NOT_FOUND;
    v_29.material = None;
    v_25.Tile = Content_e(v_29);
    a1t.Tile = Foreground_e(v_25);
...
bool rockLight_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    value a_ = a1;
    if(a_.Tile == NOT_FOUND || a_.material != Rock) return false;
    uint x_ = a_.Tile;

    value b_ = a2;
    if(b_.Tile == NOT_FOUND || b_.material != Rock) return false;
    uint y_ = b_.Tile;
...
bool shaftEnter_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    value a_ = a1;
    if(a_.Tile == NOT_FOUND || a_.Tile == NOT_FOUND) return false;
    value d_ = DirectionHV_d(a_.Tile);
    value v_1 = ShaftForeground_d(a_.Tile);
    if(v_1.material != None) return false;

    value b_ = a2;
    if(b_.Tile == NOT_FOUND) return false;
    value i_ = Foreground_d(b_.Tile);
    if(i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    value v_2 = Content_d(i_.Tile);
    if(v_2.material != None) return false;
    value v_3 = ImpClimb_d(i_.Tile);
    ...
    v_10 = ALL_NOT_FOUND;
    v_10.material = None;
    v_9.Tile = Content_e(v_10);
    a1t.Tile = ShaftForeground_e(v_9);
    a2t = b_;
    value v_11;
    v_11 = ALL_NOT_FOUND;
    v_11.material = None;
    a2t.Tile = Foreground_e(v_11);
...
bool shaftExit_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    value d_ = DirectionHV_d(a_.Tile);
    value v_1 = ShaftForeground_d(a_.Tile);
    if(v_1.Tile == NOT_FOUND || v_1.material != ShaftImp) return false;
    value c_ = Content_d(v_1.Tile);

    value b_ = a2;
    if(b_.Tile == NOT_FOUND) return false;
    value v_2 = Foreground_d(b_.Tile);
    if(v_2.material != None) return false;
    ...
    v_12 = ALL_NOT_FOUND;
    v_12.material = None;
    a1t.Tile = ShaftForeground_e(v_12);
    a2t = b_;
    value v_13;
    v_13 = ALL_NOT_FOUND;
    v_13.material = Imp;
    value v_14;
    v_14 = d2_;
    v_13.Tile = DirectionH_e(v_14);
    value v_15;
    v_15 = ALL_NOT_FOUND;
    v_15.material = None;
    v_13.Tile = ImpClimb_e(v_15);
    uint v_16;
    v_16 = 0u;
    ...
    value v_17;
    v_17 = c_;
    v_13.Tile = Content_e(v_17);
    a2t.Tile = Foreground_e(v_13);
...
bool shaftSwapEnter_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    if(b_.Tile == NOT_FOUND) return false;
    value v_2 = Foreground_d(b_.Tile);
    if(v_2.Tile == NOT_FOUND || v_2.Tile == NOT_FOUND || v_2.Tile == NOT_FOUND || v_2.material != Imp) return false;
    value v_3 = Content_d(v_2.Tile);
    if(v_3.material != None) return false;
    value v_4 = ImpClimb_d(v_2.Tile);
    ...
    v_16 = ALL_NOT_FOUND;
    v_16.material = None;
    v_15.Tile = Content_e(v_16);
    a1t.Tile = ShaftForeground_e(v_15);
    a2t = b_;
    value v_17;
    v_17 = ALL_NOT_FOUND;
    v_17.material = Imp;
    value v_18;
    v_18 = d2_;
    v_17.Tile = DirectionH_e(v_18);
    value v_19;
    v_19 = ALL_NOT_FOUND;
    v_19.material = None;
    v_17.Tile = ImpClimb_e(v_19);
    uint v_20;
    v_20 = 0u;
    ...
    value v_21;
    v_21 = c_;
    v_17.Tile = Content_e(v_21);
    a2t.Tile = Foreground_e(v_17);
...
bool shaftDigEnter_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    value a_ = a1;
    if(a_.Tile == NOT_FOUND || a_.Tile == NOT_FOUND || a_.material != Rock) return false;
    uint v_1 = a_.Tile;
    if(v_1 != 1u) return false;
    value ore_ = Vein_d(a_.Tile);
    ...
    value v_6;
    v_6 = ore_;
    v_5.Tile = Content_e(v_6);
    a1t.Tile = ShaftForeground_e(v_5);
    value v_7;
    value v_8;
    v_8 = ALL_NOT_FOUND;
    v_8.material = Up;
    if(!rotate_f(seed, transform, v_8, v_7)) return false;
    a1t.Tile = DirectionHV_e(v_7);
    a2t = b_;
    value v_9;
    v_9 = ALL_NOT_FOUND;
    v_9.material = None;
    a2t.Tile = Foreground_e(v_9);
...
bool shaftDig_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    value b_ = a2;
    if(b_.Tile == NOT_FOUND || b_.material != Shaft) return false;
    value v_2 = ShaftForeground_d(b_.Tile);
    if(v_2.Tile == NOT_FOUND || v_2.material != ShaftImp) return false;
    value v_3 = Content_d(v_2.Tile);
    if(v_3.material != None) return false;
    ...
    value v_5;
    v_5 = ore_;
    v_4.Tile = Content_e(v_5);
    a1t.Tile = ShaftForeground_e(v_4);
    value v_6;
    value v_7;
    v_7 = ALL_NOT_FOUND;
    v_7.material = Up;
    if(!rotate_f(seed, transform, v_7, v_6)) return false;
    a1t.Tile = DirectionHV_e(v_6);
    a2t = b_;
    value v_8;
    v_8 = ALL_NOT_FOUND;
    v_8.material = None;
    a2t.Tile = ShaftForeground_e(v_8);
...
bool shaftAscend_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    value b_ = a2;
    if(b_.Tile == NOT_FOUND) return false;
    value i_ = ShaftForeground_d(b_.Tile);
    if(i_.Tile == NOT_FOUND || i_.material != ShaftImp) return false;
    value v_2 = Content_d(i_.Tile);
    if(v_2.material != None) return false;
    ...
    value v_7;
    v_7 = i_;
    a1t.Tile = ShaftForeground_e(v_7);
    a2t = b_;
    value v_8;
    v_8 = ALL_NOT_FOUND;
    v_8.material = None;
...
bool shaftDescend_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    if(a_.Tile == NOT_FOUND || a_.Tile == NOT_FOUND) return false;
    value d_ = DirectionHV_d(a_.Tile);
    value i_ = ShaftForeground_d(a_.Tile);
    if(i_.Tile == NOT_FOUND || i_.material != ShaftImp) return false;
    value c_ = Content_d(i_.Tile);

    value b_ = a2;
    if(b_.Tile == NOT_FOUND) return false;
    value v_1 = ShaftForeground_d(b_.Tile);
    if(v_1.material != None) return false;
    ...
    value v_10;
    v_10 = i_;
    a2t.Tile = ShaftForeground_e(v_10);
...
bool shaftSwap_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    if(a_.Tile == NOT_FOUND || a_.Tile == NOT_FOUND) return false;
    value d_ = DirectionHV_d(a_.Tile);
    value i1_ = ShaftForeground_d(a_.Tile);
    if(i1_.Tile == NOT_FOUND || i1_.material != ShaftImp) return false;
    value c_ = Content_d(i1_.Tile);

    value b_ = a2;
    if(b_.Tile == NOT_FOUND) return false;
    value i2_ = ShaftForeground_d(b_.Tile);
    if(i2_.Tile == NOT_FOUND || i2_.material != ShaftImp) return false;
    value v_1 = Content_d(i2_.Tile);
    if(v_1.material != None) return false;
...
bool shaftRemove_r(inout uint seed, uint transform, value a1, value b1, value c1, value a2, inout value b2, value c2, value a3, value b3, value c3) {
    ...
    value c_ = b2;
    if(c_.Tile == NOT_FOUND) return false;
    value d_ = DirectionHV_d(c_.Tile);
    ...
    switch(m_12) { case 0:
        value v_13 = v_11;
        if(v_13.Tile == NOT_FOUND || v_13.material != Shaft) break;
        value xd_ = DirectionHV_d(v_13.Tile);
        bool v_14;
        value v_15;
        value v_16;
        v_16 = ALL_NOT_FOUND;
    ...
    switch(m_22) { case 0:
        value v_23 = v_21;
        if(v_23.Tile == NOT_FOUND || v_23.material != Shaft) break;
        value yd_ = DirectionHV_d(v_23.Tile);
        bool v_24;
        value v_25;
        value v_26;
        v_26 = ALL_NOT_FOUND;
    ...
    switch(m_32) { case 0:
        value v_33 = v_31;
        if(v_33.Tile == NOT_FOUND || v_33.material != Shaft) break;
        value zd_ = DirectionHV_d(v_33.Tile);
        bool v_34;
        value v_35;
        value v_36;
        v_36 = ALL_NOT_FOUND;
    ...
    switch(m_47) { case 0:
        value v_48 = v_46;
        if(v_48.Tile == NOT_FOUND) break;
        value v_49 = ShaftForeground_d(v_48.Tile);
        ...
        v_50 = ALL_NOT_FOUND;
        v_50.material = None;
        b2t.Tile = Foreground_e(v_50);
        value v_51;
        v_51 = ALL_NOT_FOUND;
        v_51.material = None;
        b2t.Tile = Background_e(v_51);
        m_47 = 1;
    default: break; }
    switch(m_47) { case 0:
        value v_52 = v_46;
        if(v_52.Tile == NOT_FOUND) break;
        value i_ = ShaftForeground_d(v_52.Tile);
        if(i_.Tile == NOT_FOUND || i_.material != ShaftImp) break;
        value v_53 = Content_d(i_.Tile);
        ...
        v_54.Tile = Content_e(v_55);
        b2t.Tile = ShaftForeground_e(v_54);
        m_47 = 1;
    default: break; }
...
bool impStep_r(inout uint seed, uint transform, value b1, inout value b2, value b3) {
    ...
    value a_ = b2;
    if(a_.Tile == NOT_FOUND) return false;
    value i_ = Foreground_d(a_.Tile);
    if(i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    value d_ = DirectionH_d(i_.Tile);
    uint s_ = i_.Tile;
...
bool impWalk_r(inout uint seed, uint transform, value b1, value c1, inout value b2, inout value c2, value b3, value c3) {
    ...
    value b_ = c2;
    if(b_.Tile == NOT_FOUND) return false;
    value v_5 = Foreground_d(b_.Tile);
...
bool impFall_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    if(a_.Tile == NOT_FOUND) return false;
    value i_ = Foreground_d(a_.Tile);
    if(i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    value v_1 = ImpClimb_d(i_.Tile);
    if(v_1.material != None) return false;

    value b_ = a2;
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND) return false;
    value l_ = Background_d(b_.Tile);
    value v_2 = Foreground_d(b_.Tile);
    if(v_2.material != None) return false;
    ...
    v_6 = ALL_NOT_FOUND;
    v_6.material = None;
    a1t.Tile = Foreground_e(v_6);
    a2t = b_;
    value v_7;
    v_7 = i_;
    a2t.Tile = Foreground_e(v_7);
...
bool impSwap_r(inout uint seed, uint transform, inout value a1, inout value b1) {
    value a_ = a1;
    if(a_.Tile == NOT_FOUND) return false;
    value i1_ = Foreground_d(a_.Tile);
    if(i1_.Tile == NOT_FOUND || i1_.Tile == NOT_FOUND || i1_.Tile == NOT_FOUND || i1_.material != Imp) return false;
    value v_1 = ImpClimb_d(i1_.Tile);
    if(v_1.material != None) return false;
    value v_2 = DirectionH_d(i1_.Tile);
    ...
    value b_ = b1;
    if(b_.Tile == NOT_FOUND) return false;
    value i2_ = Foreground_d(b_.Tile);
    if(i2_.Tile == NOT_FOUND || i2_.Tile == NOT_FOUND || i2_.Tile == NOT_FOUND || i2_.material != Imp) return false;
    value v_4 = ImpClimb_d(i2_.Tile);
    if(v_4.material != None) return false;
    value v_5 = DirectionH_d(i2_.Tile);
...
bool impTurn_r(inout uint seed, uint transform, value b1, value c1, inout value b2, inout value c2, value b3, value c3) {
    ...
    v_21.Tile = DirectionH_e(v_23);
    b2t.Tile = Foreground_e(v_21);
    c2t = b_;
...
bool ladderEnter_r(inout uint seed, uint transform, value a2, inout value b2, value c2) {
    value a_ = a2;
    if(a_.Tile == NOT_FOUND) return false;
    value v_1 = Background_d(a_.Tile);
    if(v_1.Tile == NOT_FOUND || v_1.material != Sign) return false;
    value v_ = DirectionV_d(v_1.Tile);

    value b_ = b2;
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND) return false;
    value v_2 = Background_d(b_.Tile);
    ...
    value v_11;
    v_11 = v_;
    v_10.Tile = ImpClimb_e(v_11);
    uint v_12;
    v_12 = 1u;
    if(v_12 >= 3u) return false;
    v_10.Tile = v_12;
    b2t.Tile = Foreground_e(v_10);
...
bool ladderExit_r(inout uint seed, uint transform, value b1, inout value b2, value b3) {
    ...
    value b_ = b2;
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND) return false;
    value v_1 = Background_d(b_.Tile);
    if(v_1.material != Ladder) return false;
    value i_ = Foreground_d(b_.Tile);
    if(i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    uint s_ = i_.Tile;
    value d_ = ImpClimb_d(i_.Tile);
    ...
    switch(m_12) { case 0:
        value v_13 = v_11;
        if(v_13.Tile == NOT_FOUND) break;
        value v_14 = Background_d(v_13.Tile);
    ...
    v_18 = ALL_NOT_FOUND;
    v_18.material = None;
    v_17.Tile = ImpClimb_e(v_18);
    uint v_19;
    v_19 = 1u;
    if(v_19 >= 3u) return false;
    v_17.Tile = v_19;
    b2t.Tile = Foreground_e(v_17);
...
bool ladderCheck_r(inout uint seed, uint transform, inout value a1) {
    value a_ = a1;
    if(a_.Tile == NOT_FOUND || a_.Tile == NOT_FOUND) return false;
    value b_ = Background_d(a_.Tile);
    value i_ = Foreground_d(a_.Tile);
    if(i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    value c_ = ImpClimb_d(i_.Tile);
    ...
    v_12 = ALL_NOT_FOUND;
    v_12.material = None;
    v_11.Tile = ImpClimb_e(v_12);
    a1t.Tile = Foreground_e(v_11);
...
bool ladderClimb_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    value v_1 = Background_d(a_.Tile);
    if(v_1.material != Ladder) return false;
    value v_2 = Foreground_d(a_.Tile);
    if(v_2.material != None) return false;

    value b_ = a2;
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND) return false;
    value v_3 = Background_d(b_.Tile);
...
bool ladderSwap_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    ...
    if(v_1.material != Ladder) return false;
    value i1_ = Foreground_d(a_.Tile);
    if(i1_.Tile == NOT_FOUND || i1_.Tile == NOT_FOUND || i1_.material != Imp) return false;
    uint v_2 = i1_.Tile;
    if(v_2 != 2u) return false;
    value v_3 = ImpClimb_d(i1_.Tile);
    if(v_3.material != Down) return false;

    value b_ = a2;
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND) return false;
    value v_4 = Background_d(b_.Tile);
    if(v_4.material != Ladder) return false;
    value i2_ = Foreground_d(b_.Tile);
    if(i2_.Tile == NOT_FOUND || i2_.Tile == NOT_FOUND || i2_.material != Imp) return false;
    uint v_5 = i2_.Tile;
    if(v_5 != 2u) return false;
    value v_6 = ImpClimb_d(i2_.Tile);
...
bool chestPut_r(inout uint seed, uint transform, inout value a1, inout value a2) {
    value x_ = a1;
    if(x_.Tile == NOT_FOUND) return false;
    value b_ = BuildingVariant_d(x_.Tile);
    if(b_.Tile == NOT_FOUND || b_.Tile == NOT_FOUND || b_.material != BigChest) return false;
    uint n_ = b_.Tile;
    value c_ = Content_d(b_.Tile);

    value y_ = a2;
    if(y_.Tile == NOT_FOUND) return false;
    value i_ = Foreground_d(y_.Tile);
    if(i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.Tile == NOT_FOUND || i_.material != Imp) return false;
    value p_1_ = Content_d(i_.Tile);
    value v_1 = ImpClimb_d(i_.Tile);
    if(v_1.material != None) return false;
    uint v_2 = i_.Tile;
    if(v_2 != 2u) return false;
    ...
    v_8.Tile = v_9;
    a1t.Tile = BuildingVariant_e(v_8);
    a2t = y_;
    value v_10;
    v_10 = i_;
    value v_11;
    v_11 = ALL_NOT_FOUND;
    v_11.material = None;
    v_10.Tile = Content_e(v_11);
    a2t.Tile = Foreground_e(v_10);
...
void main() {
    ...
    if(true) {
        ...
        if(true) {
            value b2r = Foreground_d(b2.Tile);
            value c2r = Foreground_d(c2.Tile);
            value b3r = Foreground_d(b3.Tile);
            value c3r = Foreground_d(c3.Tile);
            seed ^= 108567334u;
            ...
            b2.Tile = Foreground_e(b2r);
            c2.Tile = Foreground_e(c2r);
            b3.Tile = Foreground_e(b3r);
            c3.Tile = Foreground_e(c3r);
        }
    }
